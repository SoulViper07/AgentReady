...
export const PipelineRail: React.FC<PipelineRailProps> = ({
  ...
  const steps = [
    {
      ...
      authority: 'RAW DATA',
      badgeClass: 'bg-[#181A20] text-stone-300 border-white/[0.08]',
    },
    {
      id: 2,
      name: 'AI Extraction',
      ...
      badgeClass: 'bg-amber-950/40 text-amber-200 border-amber-500/30',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      badgeClass: 'bg-amber-950/30 text-amber-300 border-amber-500/30',
    },
    {
      id: 6,
      name: 'Razorpay Rails',
  ...
  return (
    <div className="w-full rounded-2xl bg-[#181A20]/90 border border-white/[0.08] p-5 shadow-xl shadow-black/20 backdrop-blur-md">
      <div className="flex items-center justify-between pb-3.5 mb-4 border-b border-white/[0.08]">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="text-xs font-mono font-bold uppercase tracking-widest text-stone-300">
            End-to-End Commerce Pipeline Tracker
          </h3>
          <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#121316] text-stone-400 border border-white/[0.08] hidden sm:inline">
          ...
          return (
            <div
              ...
              className={`relative rounded-xl p-3.5 flex flex-col justify-between transition-all duration-300 border ${
                isCompleted
                  ? 'bg-[#121316] border-emerald-500/30 shadow-sm shadow-emerald-950/20'
                  : isActive
                  ? 'bg-[#121316] border-amber-500/40 shadow-md shadow-amber-950/30 ring-1 ring-amber-500/30'
                  : 'bg-[#121316]/50 border-white/[0.06] opacity-60'
              }`}
            >
                ...
                <div
                  className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 border ${
                    isCompleted
                      ...
                      : 'bg-[#181A20] border-white/[0.08] text-stone-500'
                  }`}
                >
                  <StepIcon className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-stone-200 tracking-tight leading-snug">
                    {step.name}
                  </h4>
                  <p className="text-[10px] font-mono text-stone-400 truncate max-w-[110px]">
                    {step.subtext}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-3 pt-2 border-t border-white/[0.06] flex items-center justify-between text-[10px] font-mono">
                {isCompleted ? (
                  ...
                  <span className="text-stone-600">Pending Gate</span>
                )}
              </div>
            </div>
          );
